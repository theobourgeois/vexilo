...
import { Loader2, Upload, X, CheckCircle, ArrowLeft, Info } from "lucide-react";
...
export default function PostFlagPage() {
	...
	const handlePost = async () => {
		...
		try {
			...
			console.error(error);
			toast.error("An error occurred while posting the flag. This flag may already exist.");
		} finally {
			setIsLoading(false);
		}
	};
			...
			<div className="max-w-4xl mx-auto px-4 py-12">
				<Card className="w-full max-w-md mx-auto">
					<CardHeader className="text-center">
						...
						<CardTitle className="text-2xl">Sign in to Post a Flag</CardTitle>
						<CardDescription>
							You need to be signed in to share flags with the community
						</CardDescription>
					</CardHeader>
			...
			<div className="max-w-4xl mx-auto px-4 py-12">
				<Card className="w-full max-w-md mx-auto">
					<CardHeader className="text-center">
						...
						<CardTitle className="text-2xl">Flag Submitted!</CardTitle>
						<CardDescription>
							Your flag is under review. Thank you for contributing to our
							community!
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-4">
						<div className="flex gap-3">
							<Button className="flex-1" onClick={handleCreateAnother}>
								Create Another
							</Button>
							<Button
								variant="neutral"
		...
		<div className="max-w-4xl mx-auto px-4 py-12">
			<div className="space-y-6">
				<div className="text-center">
					<h1 className="text-3xl font-bold tracking-tight">Post a Flag</h1>
					...
					<CardContent className="space-y-6">
						...
						<div className="space-y-2">
							...
							<Alert className="mb-4 mt-2">
								<Info />
								<AlertTitle>Image Quality Guidelines</AlertTitle>
								<AlertDescription>
									Upload a high-quality image of the flag. SVG format is
									preferred for crisp, scalable graphics that look great at any
									size.
								</AlertDescription>
							</Alert>
							...
							<div className="space-y-2">
								<label htmlFor="relatedFlags" className="text-sm font-semibold">
									Related Flags
								</label>
								<RelatedFlagInput
									relatedFlags={relatedFlags}
